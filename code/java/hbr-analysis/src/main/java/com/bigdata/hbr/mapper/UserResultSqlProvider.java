...
import com.bigdata.hbr.entity.UserResultExample.Criteria;
import com.bigdata.hbr.entity.UserResultExample.Criterion;
import com.bigdata.hbr.entity.UserResultExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class UserResultSqlProvider {

    public String insertSelective(UserResult record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_result");
    ...
    public String selectByExample(UserResultExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserResult record = (UserResult) parameter.get("record");
        UserResultExample example = (UserResultExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(UserResult record) {
        SQL sql = new SQL();
        sql.UPDATE("user_result");
    ...
    protected void applyWhere(SQL sql, UserResultExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
