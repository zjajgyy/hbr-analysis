...
import com.bigdata.hbr.entity.UserExample.Criteria;
import com.bigdata.hbr.entity.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getPwdSalt() != null) {
            sql.VALUES("pwd_salt", "#{pwdSalt,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPwdSalt() != null) {
            sql.SET("pwd_salt = #{record.pwdSalt,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getPwdSalt() != null) {
            sql.SET("pwd_salt = #{pwdSalt,jdbcType=VARCHAR}");
        }
