    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                  <a href="/hbr/home/?location=admin-patient">
                            ...
                            <div class="row">
                              <div class="col-sm-4">
                                <div class="input-group">
                                  <input id="doctor-name" type="text" placeholder="请输入医生姓名" class="input-sm form-control">
          ...
          success: function (res) {
              ...
              if(typeof res == 'object' && res.code == 200) {
                  for (var i=0; i<res.data.length; ++i) {
                      var obj = res.data[i];
                      var doctorTemplate = '<tr> <td>{no}</td> <td>{name}</td> <td>{gender}</td> <td>{username}</td> <td>{status}</td> <td> <button class="btn btn-xs btn-warning"> <strong>修改</strong> </button> <button class="btn btn-xs btn-danger"> <strong>注销</strong> </button> </td> </tr>';
                      ...
                      $("#doctor-data").append(doctorTemplate);
                  }
