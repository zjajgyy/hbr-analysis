...
import org.apache.hadoop.hbase.client.{ConnectionFactory,Put,Get,Delete,Scan,HTable}
...
//   val rdd = sc.makeRDD(List(SD1,SD2))
   var result:Int = 0
   //var result = sameModel.predict(rdd)
   
   saveToMySQL(SD1,SD2,result,userName)
...
def saveToMySQL(SD1:Double,SD2:Double,result:Int,userName:String)
{
 ...
 val url = "jdbc:mysql://121.194.62.243:3306/hbr_analysis"  
 val username = "hbr"  
